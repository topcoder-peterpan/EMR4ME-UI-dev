...
const SIZES = {
    ...
    NAVBAR_VERTICAL: 16,
    NAVBAR_TITLE_FLEX: 2,
    NAVBAR_TITLE_HEIGHT: screenHeight * 0.07,
    NAVBAR_TITLE_TEXT: 16 * 0.875,
    NAVBAR_LEFT_FLEX: 0.5,
    NAVBAR_LEFT_HEIGHT: screenHeight * 0.07,
    NAVBAR_LEFT_MARGIN: 16,
    NAVBAR_RIGHT_FLEX: 0.5,
    NAVBAR_RIGHT_HEIGHT: screenHeight * 0.07,
...
const iPhoneX = () => Platform.OS === 'ios' && (screenHeight === 812 || screenWidth === 812);
const vh = screenHeight / 100;
const vw = screenWidth / 100;
const loadingListCount = 25;
export default {
    StatusHeight,
    HeaderHeight,
    iPhoneX,
