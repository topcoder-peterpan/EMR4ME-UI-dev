...
class Select2 extends Component {
  static defaultProps = {
    ...
    selectButtonText: i18n.t("reminder.choose"),
    searchPlaceHolderText: i18n.t("reminder.search"),
    listEmptyTitle: i18n.t("reminder.noSearchFound"),
  ...
  init(newProps) {
    ...
    this.enableSelectButton = !!preSelectedItem.length;
  ...
  onItemSelected = (item, isSelectSingle) => {
    ...
    this.enableSelectButton = !!selectedItem.length;
  };
    ...
    return (
      ...
      >
        <Modal
          ...
          onDismiss={() => {
            if (this.selectButtonPressed && selectCallback) {
              selectCallback();
          ...
          >
            ...
            <View style={styles.buttonWrapper}>
              ...
              <Button
                ...
                disabled={!this.enableSelectButton}
                ...
                style={[
                  ...
                  !this.enableSelectButton && styles.disabledButton
                ]}
              />
            </View>
          </Animated.View>
